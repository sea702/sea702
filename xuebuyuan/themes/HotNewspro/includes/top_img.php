<div id="top_hot">
	<div id="featured">
	<?php 
		$loop = new WP_Query( array( 'post_type' => 'picture', 'posts_per_page' => 4, 'orderby' => rand ) );
	...
	?>
		<div class="item">
			<div class="top_t">
					...
					<a href="<?php echo $img; ?>" rel="bookmark" title="<?php the_title(); ?>"><img src="<?php echo $image; ?>" alt="<?php the_title(); ?>"/></a>
					<?php else: ?>
			</div>
			<!-- 截图 -->
