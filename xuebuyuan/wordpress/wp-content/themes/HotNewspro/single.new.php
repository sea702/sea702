...
<div id="content">
	 ...
	 <!-- menu -->
		<div id="map">
			<div class="browse">现在的位置: <a title="返回首页" href="<?php echo get_settings('Home'); ?>/">首页</a> &gt; 技术 &gt; 正文</div>
		...
		<div class="entrymeta">
			...
			<span class="spostinfo">
				<ul>
					<li>该日志由 <?php the_author() ?> 于<?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) . '前'; ?>发表，最后更新于 <?php the_modified_date('Y年m月d日'); ?>.</li>
